...
def parse_arguments():
    ...
    parser.add_argument( '--model', default='./media/lidan/ssd2/SemiCD/saved/LEVIR-CD/SemiCD_(semi)_5/best_model.pth', type=str,
                        help='Path to the trained .pth model')
    parser.add_argument('--images',default='/media/lidan/ssd2/CDData/LEVIR-CD256/list', type=str)
    parser.add_argument( '--save', action='store_true', help='Save images')
    parser.add_argument('--Dataset_Path', default="E:\workspace\SemiCD-main\media\lidan\ssd2\CDData\LEVIR-CD256", type=str,
